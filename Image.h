...
#endif
#ifdef _MAX_PATH
#define _FILE_NAME_LEN_ _MAX_PATH
#else
#define _FILE_NAME_LEN_ 260
#endif
...
public: 
					  ...
					  )
	{
		...
		static char ResMaskName[_FILE_NAME_LEN_];
	...
	//////////////////////////窗口////////////////////////////
	static inline DWORD*GetWndPtDword(){
		return Pscreen;			//窗口内存指针
	}
	static inline COLOR*GetWndPtColor(){
		return Cscreen;			//窗口颜色指针
	}
